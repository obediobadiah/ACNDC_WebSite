					...
					<div className="Resultats_Boxes">
						<div className="Resultats_Box">
							<div className="Resulats_Header">
								...
								<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis nulla dolorum eos fugit illo laborum labore iste laudantium eum cum? Quis officia incidunt aliquid modi adipisci ipsum cumque totam error?</p>
							</div>
