		...
		try {
			...
			try {
				...
				if (response.ok) {
					...
					// Email failed but subscription worked
					Swal.fire({
						title: 'Subscribed!',
						text: 'You have been successfully subscribed to our newsletter! (Email delivery may be delayed)',
						icon: 'success',
						confirmButtonColor: '#28a745',
						confirmButtonText: 'Great!'
					});
				...
				console.log('Email service unavailable, but subscription successful');
				// Email failed but subscription worked
				Swal.fire({
					title: 'Subscribed!',
					text: 'You have been successfully subscribed to our newsletter! (Email delivery may be delayed)',
			...
			Swal.fire({
				title: 'Error!',
				text: err.message || 'There was an error processing your subscription. Please try again.',
				icon: 'error',
