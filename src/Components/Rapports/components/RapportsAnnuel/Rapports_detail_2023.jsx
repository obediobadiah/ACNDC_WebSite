...
import repportAnnuel2020 from '../../assets/RAPPORT GENERAL ANNUEL DES ACTIVITES 2023.pdf'
...
function Rapports_detail() {
	...
	const handleDownload = () => {
		...
		link.download = 'ACNDC RAPPORT GENERAL ANNUEL 2023.pdf';
		link.click();
	};
			...
			<div className="rapport_detail_contents">
				<div className="rapport_detail_detatils">
					<div className="rapport_detail_Intro">
						<h1>{t("rapport_boxes_txt_h1_2023")}</h1>
					</div>
					<div className="rapport_detail_date">
						<h2>{t("rapport2023_detail_date")}</h2>
					</div>
				</div>
				...
				<div className="rapport_detail_comp">
					<div className="rapport_detail_comp_txt">
						<p>{t("rapport2023_detail_comp_txt_p1")}</p>
						<p><strong>{t("rapport2023_detail_comp_txt_p2")}</strong></p>
						<p>{t("rapport2023_detail_comp_txt_p3")}</p>
					</div>
